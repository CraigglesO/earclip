...
const sea = JSON.parse(fs.readFileSync('./featureCollections/asiaMinor.json', 'utf8'))

const coords = sea.features[0].geometry.coordinates[0]

const data = earclip(coords, 32)
